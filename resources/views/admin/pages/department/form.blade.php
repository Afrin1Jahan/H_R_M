...
<form action="{{route('department.store')}}"method="post">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type ="text" name="department_name" class="form-control" id="inputname" placeholder="Text">
    </div>
    ...
    <!-- <div class="form-row">
     <div class="form-group col-md-6">
      <label for="inputtextarea">description</label>
       <textarea name="text" name="description_name "class="form-control" id="inputdescription" cols="80" rows="5"></textarea>
    </div> -->
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type ="text" name="department_no" class="form-control"  placeholder="Text">
    </div>
