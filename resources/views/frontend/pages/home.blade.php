...
<div class="templateux-cover" style="background-image: url(uploads/hero_1.jpg);">
      <div class="container">
        <div class="row align-items-lg-center">

          <div class="col-lg-6 order-lg-1">
            <h1 class="heading mb-3 text-white" data-aos="fade-up">We Are Your Partners in <strong>Human Resource</strong></h1>
          ...
          <div class="col-md-12 templateux-overlap">
            <div class="row">
              <div class="col-md-4" data-aos="fade-up" data-aos-delay="600">
                <div class="media block-icon-1 d-block text-left">
                  <div class="icon mb-3">
                    ...
                    <img src="{{url('uploads/001-consultation.svg')}}" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="col-md-4" data-aos="fade-up" data-aos-delay="700">
                <div class="media block-icon-1 d-block text-left">
                  <div class="icon mb-3">
                    <img src="{{url('uploads/002-discussion.svg')}}" alt="Image" class="img-fluid">
                  </div>
                  <div class="media-body">
              ...
              <div class="col-md-4" data-aos="fade-up" data-aos-delay="800">
                <div class="media block-icon-1 d-block text-left">
                  <div class="icon mb-3">
                    <img src="{{url('uploads/003-turnover.svg')}}" alt="Image" class="img-fluid">
                  </div>
                  <div class="media-body">
        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <div class="owl-carousel wide-slider">
              <div class="item">
                <img src="{{url('/uploads/slider-1.jpg')}}" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
              <div class="item">
                <img src="{{url('/uploads/slider-2.jpg')}}" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
              <div class="item">
                <img src="{{url('/uploads/slider-3.jpg')}}" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
            </div> <!-- .owl-carousel -->
          </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="{{url('uploads/004-gear.svg')}}" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="100">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="{{url('uploads/005-conflict.svg')}}" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
              <h3 class="h5 mb-4">Infinite Posibilities</h3>
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="200">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="{{url('uploads/006-meeting.svg')}}" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="{{url('uploads/007-brainstorming.svg')}}" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="500">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="{{url('uploads/009-brainstorming-2.svg')}}" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
  ...
  <div class="container templateux-section">
    ...
    <div class="d-flex flex-sm-row">
      <a href="#" class="block-thumbnail-1 one-third" style="background-image: url('uploads/slider-2.jpg'); " data-aos="fade">
        <div class="block-thumbnail-content">
          <h2>When she reached the first</h2>
          <span class="post-meta">June 18, 2020  &bullet; by Admin</span>
        </div>
      </a>
      <a href="#" class="block-thumbnail-1 two-third" style="background-image: url('uploads/slider-1.jpg'); " data-aos="fade" data-aos-delay="100">
        <div class="block-thumbnail-content">
    ...
    <div class="d-flex flex-column flex-sm-row">
      <a href="#" class="block-thumbnail-1 two-third" style="background-image: url('uploads/slider-3.jpg'); " data-aos="fade" data-aos-delay="200">
        <div class="block-thumbnail-content">
